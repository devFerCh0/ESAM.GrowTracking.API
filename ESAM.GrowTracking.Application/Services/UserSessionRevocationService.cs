...
namespace ESAM.GrowTracking.Application.Services
{
    public class UserSessionRevocationService : IUserSessionRevocationService
    {
        ...
        public async Task<(List<UserSessionRefreshToken> UserSessionRefreshTokensToRevoke, List<BlacklistedRefreshToken> BlacklistedRefreshTokens)>
            RevokeUserSessionAsync(UserSession userSession, string revokedReason, int currentUserId, DateTime utcNow, bool asTracking, CancellationToken cancellationToken)
        {
            ...
            return (userSessionRefreshTokensToRevoke, blacklistedRefreshTokens);
        }
