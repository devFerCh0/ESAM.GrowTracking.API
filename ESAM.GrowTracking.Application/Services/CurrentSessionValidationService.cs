...
namespace ESAM.GrowTracking.Application.Services
{
    public class CurrentSessionValidationService : ICurrentSessionValidationService
    {
        ...
        public async Task<Result> ValidateCurrentTemporaryAsync(string currentJti, int currentUserId, string currentSecurityStamp, int currentTokenVersion, int currentUserDeviceId, 
            ...
            bool asTracking, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.LogWarning("ValidateCoreIdentityAsync: usuario inválido o bloqueado. UserId={UserId}", currentUserId);
            ...
            {
                _logger.LogWarning("ValidateCoreIdentityAsync: usuario inválido por cambios en la cuenta. UserId={UserId}", currentUserId);
            ...
            {
                _logger.LogWarning("ValidateCoreIdentityAsync: dispositivo inválido o bloqueado. UserId={UserId}, DeviceId={DeviceId}", currentUserId, currentUserDeviceId);
