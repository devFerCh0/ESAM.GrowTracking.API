    ...
    public class GetUserRoleCampusesQueryHandler : IRequestHandler<GetUserRoleCampusesQuery, Result<List<GetUserRoleCampusResponse>>>
    {
        ...
        public async Task<Result<List<GetUserRoleCampusResponse>>> Handle(GetUserRoleCampusesQuery request, CancellationToken cancellationToken)
        {
            ...
            if (currentUserValidationResult.IsFailure)
                return Result<List<GetUserRoleCampusResponse>>.Fail(currentUserValidationResult.Errors);
            ...
            if (currentUserDeviceValidationResult.IsFailure)
                return Result<List<GetUserRoleCampusResponse>>.Fail(currentUserDeviceValidationResult.Errors);
