...
namespace ESAM.GrowTracking.Persistence.DataAccess.Repositories
{
        ...
        : Repository<UserSessionRefreshToken, int>(logger, context), IUserSessionRefreshTokenRepository
    {
        ...
        //    return await query.FirstOrDefaultAsync(usrt => usrt.Identifier == identifier, cancellationToken).ConfigureAwait(false);
        //}
        ...
        //{
        //    var query = asTracking ? _dbSet.AsTracking() : _dbSet.AsNoTracking();
        //    return await query.Where(usrt => usrt.UserSessionId == userSessionId).ToListAsync(cancellationToken).ConfigureAwait(false);
        //}
