...
namespace ESAM.GrowTracking.Persistence.DataAccess.Queries
{
    ...
    {
        public async Task<List<GetUserRoleCampusResponse>> GetUserRoleCampusesByUserIdAsync(int userId, bool asTracking = false, CancellationToken cancellationToken = default)
        {
