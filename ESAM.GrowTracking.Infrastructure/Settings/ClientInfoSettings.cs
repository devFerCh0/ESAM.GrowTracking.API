    ...
    public sealed class ClientInfoSettings
    {
        ...
        public void Validate()
        {
            if (IpHeaderKeys == null || IpHeaderKeys.Count == 0)
                throw new InvalidOperationException($"El campo {nameof(IpHeaderKeys)} no puede estar vacío. Se requiere al menos un encabezado para identificar la IP del cliente.");
